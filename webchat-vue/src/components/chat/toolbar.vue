    ...
    <div id="btnBar">
      <div class="topBtnBar">
        <el-tooltip class="item" effect="dark" content="进入群聊" placement="right">
          <el-button @click="chooseChatList('群聊');hideChat(false)" class="toolBtn" size="small"><i class="fa fa-comments-o fa-2x"
                                                                                   aria-hidden="true"></i></el-button>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="用户列表" placement="right">
          <el-button @click="chooseChatList('私聊');hideChat(false)" class="toolBtn" size="small"><i class="fa fa-address-book-o fa-2x"
                                                                                   aria-hidden="true"></i></el-button>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="进入朋友圈" placement="right">
          <el-button @click="chooseChatList('朋友圈');hideChat(true)" class="toolBtn" size="small"><i class="fa fa-android fa-2x"
                                                                                    aria-hidden="true"></i></el-button>
        </el-tooltip>
      </div>
      <div class="bottomBtnBar">
        <el-tooltip class="item" effect="dark" content="更多" placement="right">
          ...
          >
            ...
            <el-button slot="reference" class="toolBtn" size="small"><i class="fa fa-bars fa-2x" aria-hidden="true"></i>
            </el-button>
          </el-popover>
        </el-tooltip>
...
export default {
  ...
  methods: {
    ...
    // 是否隐藏聊天界面
    hideChat: function (flag) {
      console.log("子组件-是否隐藏聊天界面：", flag);
      this.$emit("childEvent", flag);
    }
  }
}
</script>
