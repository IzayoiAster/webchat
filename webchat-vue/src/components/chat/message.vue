<template>
  <div id="message" v-scroll-bottom="sessions" ref="message">

    <!-- 私聊 -->
    <div v-if="currentSession&&(currentSession.username!='群聊'&&currentSession.username!='朋友圈')">
      <ul>
    ...
    <!-- 群聊 -->
    <div v-else-if="currentSession&&currentSession.username!='朋友圈'">
      <ul>
...
<!-- -->
          ...
          <div class="main" :class="{self:entry.fromId==user.id}">
            ...
            <img @dblclick="takeAShot" class="avatar" :src="entry.fromId==user.id? user.userProfile:entry.fromProfile"
                 alt="">
