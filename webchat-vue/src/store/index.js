...
const store =  new Vuex.Store({
  state:sessionStorage.getItem('state') ? JSON.parse(sessionStorage.getItem('state')) :{
    ...
    sessions:{}, //用户列表
    users:[], //当前登录用户
    currentUser:null, //当前选中的用户，默认为群聊
    currentSession:{username:'群聊',nickname:'群聊'}, //当前聊天窗口列表
    currentList:'群聊',
    filterKey:'',
    stomp:null, //两用户之间是否有未读信息
    isDot:{}, //错误提示图片
    errorImgUrl:"http://39.108.169.57/group1/M00/00/00/J2ypOV7wJkyAAv1fAAANuXp4Wt8303.jpg", //拍一拍的记录历史
    shotHistory:{}
  },
  mutations:{
    //
