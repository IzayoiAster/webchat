package com.aster.webchat.config;

import com.aster.webchat.service.impl.AdminServiceImpl;
import com.aster.webchat.service.impl.UserServiceImpl;
...
import com.aster.webchat.api.entity.Admin;
...
public class MultiHttpSecurityConfig {
    ...
    public static class AdminSecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        // 忽略登录、验证码和swagger文档请求的过滤器，该请求不需要进入Security的拦截器
        @Override
        public void configure(WebSecurity web) throws Exception {
            web.ignoring().antMatchers("/css/**", "/fonts/**", "/img/**", "/js/**", "/favicon.ico", "/index.html", "/admin/login", "/admin/mailVerifyCode", "/swagger-ui.html", "/swagger-ui/*", "/swagger-resources/**", "/v2/api-docs", "/v3/api-docs");
        }
